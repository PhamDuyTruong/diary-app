...
import happy from '../../assets/img/Feelings/happy.png';
import sad from '../../assets/img/Feelings/sad.png';
import mixed from '../../assets/img/Feelings/mixed-feelings.png';
import motivated from '../../assets/img/Feelings/motivated.png';
import okay from '../../assets/img/Feelings/okay.png';

const Entry = (props) => {
    const {entry, onEditClick, onDeleteClick, showEntry, handleEntryClose} = props;
  ...
  >
    ...
    >
      <button type="button" onClick={() => onEditClick(entry)} className="">
        <abbr title="Edit">
          <img
            src="../../assets/img/icons/edit-pencil.svg"
            alt="delete"
            className="h-5 w-5"
          />
        </abbr>
      ...
      >
        <abbr title="Delete">
          <img src="../../assets/img/icons/trash.svg" alt="delete" className="h-5 w-5" />
        </abbr>
      </button>
    </div>
    <button
