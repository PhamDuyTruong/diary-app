...
const EditEntry = (props) => {
  const { currentEntry, setIsEditing, onEditInputChange, onEditFormSubmit } =
    props;
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-around">
          <button type="submit" onClick={onEditFormSubmit}  className="bg-blue-dark px-3 py-3 mt-2 text-white-pure
