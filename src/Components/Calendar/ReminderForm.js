...
const ReminderForm = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        <fieldset className="p-3 border border-gray-light flex flex-col sm:h-full justify-around rounded-md w-full">
          ...
          <input
            ...
            shadow-inner"
          />
          <label htmlFor="dateReminder" className="p-2 rounded-md outline-none border border-gray-dark w-full shadow-inner">
             <Text tid="formDate" />
              <input
              type="date"
              name="date"
